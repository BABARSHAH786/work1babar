    ...
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-[380px] mt-0">
        ...
        <div className="flex-1 flex flex-col justify-center ">
          ...
          <p className="max-w-[500px] mx-auto xl:mx-0 mb-6 xl:mb-12 px-2 xl:px-1 ">10 years ago, I began freelancing as a developer . Sinse then i have done remote work for agency,consulted for startup and study in saylani smit  and teaching on yt of different programinig language
          </p>
          {/* counters */}
